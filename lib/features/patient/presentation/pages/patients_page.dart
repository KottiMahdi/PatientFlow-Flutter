...
class _PatientsPageState extends State<PatientsPage> {
  ...
  final FocusNode searchFocusNode =
      FocusNode(); // Focus node to manage the search bar focus state
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Patients List',
            style: TextStyle(
                color: Colors.white,
                fontWeight: FontWeight.bold)), // App bar title
              ...
              child: Row(
                children: [
                  ...
                  if (searchFocusNode.hasFocus)
                    IconButton(
                      ...
                      onPressed: () {
                        ...
                        Provider.of<PatientProviderGlobal>(context,
                                listen: false)
                            .setSearchQuery('');
                      },
                    ),
                  Expanded(
                    child: TextField(
                      controller:
                          searchController, // Attach the text controller
            ...
            Expanded(
              child: Consumer<PatientProviderGlobal>(
                builder: (context, patientProvider, child) {
                  ...
                  final List<PatientEntity> patientsList =
                      patientProvider.filteredPatients;
                  ...
                  return ListView.builder(
                    ...
                    itemCount:
                        patientsList.length, // Number of patients to display
                    itemBuilder: (context, index) {
                      final patient = patientsList[
                          index]; // Get patient data for this index
                      return Padding(
                        ...
                        child: Card(
                          ...
                          child: ListTile(
                            leading: const Icon(Icons.person,
                                color:
                                    Color(0xFF1E3A8A)), // Icon for the patient
                            title: Text(
                            ...
                            subtitle: Text(
                                'Assurance: ${patient.assurance != null && patient.assurance!.isNotEmpty ? patient.assurance : 'N/A'} | Age: ${patient.age} '), // Patient's insurance and age
                            trailing: IconButton(
      ...
      floatingActionButton: FloatingButton(
        onPressed: () {
          Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) =>
                    const AddPatientPage()), // Navigate to the AddPatientPage
          );
        },
        label: 'Add Patient',
        icon: Icons.add,
